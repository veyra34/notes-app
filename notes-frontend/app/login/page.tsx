...
export default function Login() {
    ...
    return (
        <div className="min-h-screen w-full flex bg-[#1e2330]">
            ...
            {/* --- LEFT SIDE --- */}
            <div className="w-1/2 relative flex flex-col text-white px-24 py-12 overflow-hidden">
        ...
        */}
                        ...
                        <div>
                            ...
                            <div className="mt-8 ml-4">
                                <img
                                    ...
                                    alt="Notebook"
                                    className="w-[320px] object-contain drop-shadow-2xl"
                                />
                            </div>
                        </div>
            ...
            <div className="w-1/2 flex items-center justify-center bg-[#1e2330] p-8">
                <div className="bg-white w-full max-w-[460px] rounded-3xl shadow-xl px-10 py-10 z-10">
                    ...
                    <button 
                        ...
                        className="mt-6 w-full rounded-xl bg-[#2b364a] py-3.5 text-[15px] font-semibold text-white transition hover:bg-[#1e2638] active:scale-95"
                    >
                        Login
                    </button>
